       ...
       <div class="row">
        <div class="col-sm">
          <table class="table table-borderless">
            ...
            <tbody>
              <tr>
                <th scope="row" colspan="2" style="font-size: 30px" id="article">Gặp vấn đề thắc mắc với shopSol ?</th>
              </tr>
              <tr>
                <td id='content'>Câu trả lời cho vấn đề của bạn có thể được tìm thấy trong cộng đồng shopSol hoặc nhận được từ đội ngũ hỗ trợ</td>
                <td></td>
              </tr>
              <tr>
                <td>
                  <p id='companyname'>Công ty TNHH thương mại SHOPSOL</p>
                  <p id='taxnumber'>Mã Số Thuế : 10801010014</p>

                  <ul id='content_list'>
                    <li>
                      <p id='companyaddr'>
                          <i class="fas fa-map-marker-alt"></i>
													422 Vĩnh Hưng, Hoàng Mai, Hà Nội.
                      </p>
                    </li>
                    ...
                    <li class="email" id='mail'>
                        <p><i class="fa fa-envelope"></i> info@shopsol.com.vn</p>
                    </li>
                    <li class="website" id='web'>
                      <p><i class="fa fa-globe"></i> www.shopsol.com.vn</p>
                    </li>
                  </ul>
                </td>
                <td></td>
