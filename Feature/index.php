      ...
      <div id="items_section2">
        <div class="row">
          <div class="col-sm" id="food">
            <img src="img/index_food.jpeg" alt="food/" />
            <p>THỨC ĂN</p>
          </div>
          <div class="col-sm" id="#jewelry">
            <img src="img/index_jewery.jpeg" alt="jewelry" />
            <p>TRANG SỨC</p>
          </div>
          <div class="col-sm" id="drink">
            <img src="img/index_drink.jpeg" alt="drink" />
            <p>GIẢI KHÁT</p>
          </div>
          <div class="col-sm" id="cosmetic">
            <img src="img/index_cosmetics.jpeg" alt="cosmetics" />
            <p>MỸ PHẨM</p>
          </div>
          <div class="col-sm" id="garden">
            <img src="img/index_garden.jpeg" alt="garden" />
            <p>CÂY TRỒNG</p>
          </div>
        </div>
      </div>
      ...
      <div id="items2_section2">
        <div class="row">
          ...
          <div class="col-sm">
            ...
            <p class="header-card">Chuyển đổi qua shopSol</p>
            <p>Đưa cửa hàng của bạn cho shopSol, bất kể nền tảng nào bạn đang sử dụng</p>
          </div>
          <div class="col-sm">
            <img src="img/team.png" alt="team" />
            <p class="header-card">Thuê các chuyên gia của shopSol</p>
            <p>Nhận được sự hỗ trợ từ đội ngũ Tư vấn bán hàng chuyên nghiệp của shopSol</p>
          </div>
        </div>
      </div>
    </div>
      ...
      <div class="row">
        <div class="col-sm">
          ...
          <div class="content">
            ...
            <strong>$ 200 triệu Dollar</strong> lợi nhuận khi dùng shopSol
          </div>
          <div class="link">
            <a href="./about.php">Tìm hiểu thêm về shopSol</a>
    ...
    <div id="section4">
      <div class="row">
        <div class="col-sm">
          ...
          <div class="row">
            <div class="col-sm">
              <p class="header">Hỗ trợ từ shopSol</p>
            ...
            <div class="col-sm">
              <p class="header">Các chuyên gia của shopSol</p>
              <p class="content">Thuê chuyên gia để giúp bạn mọi thứ từ cài đặt cửa hàng tới SEO</p>
            </div>
          </div>
        </div>
        <div class="col-sm" id="pic5">
          <img src="img/index_pic5.jpeg" alt="pic5" />
        </div>
      </div>
    </div>
    <div id="section5">
      <div class="row">
        <p class="header">Bắt đầu hành trình kinh doanh của bạn với shopSol</p>
      </div>
      <div class="row">
        <p class="content">Khám phá và trải nghiệm các dịch vụ của shopSol để giúp bạn xây dựng, vận hành và phát triển
          công việc của bạn</p>
      </div>
      <div class="row">
        <?php
