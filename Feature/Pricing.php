...
<body>
  ...
  <div id="body-content">
    ...
    <div class="btn-group-vertical">
      ...
      <button type="button" id="button2" onclick="myFunction2()">shopSol</button>
    ...
    <table class="table" id="my-table-basic">
      ...
      <tbody>
        ...
        <tr class="my-second-title">
          <td colspan="2">SHOPSOL GIAO HÀNG</td>
        </tr>
        <tr>
        ...
        <tr class="my-second-title">
          <td colspan="2">SHOPSOL dịch vụ thanh toán</td>
        </tr>
        <tr>
    ...
    <table class="table" id="my-table-shopify">
      ...
      <tbody>
        ...
        <tr>
          <td>Phụ phí khi sử dụng dịch vụ thanh toán không thuộc shopSol</td>
          <td>+$89 USD/1 tháng</td>
        </tr>
        <tr class="my-second-title">
          <td colspan="2">Điểm bán hàng</td>
    ...
    <div id="footer">
      <div class="container-fluid my-footer" style="background-color: #002e25; margin-top: -30px">
        ...
        <div class="row" style="padding-top: 40px">
          ...
          <div class="col-4 col-md-4">
            <a href="#" class="my-title-col">SHOPSOL</a><br />
            <a href="#">Liên hệ </a><br />
            <a href="#">Thông tin </a>
          </div>
          <div class="col-4 col-md-4">
