    ...
    <div id="header">
      ...
      <nav class="header-navbar navbar navbar-expand-md navbar-light">
        <div class="navbar-brand">
          <img src="img/shopify-seeklogo.com.svg" class="logo" alt="Logo" />
          <a class="company-name nav-link" href="./index.php">shopSol</a>
        </div>
        ...
        <div class="grid about-us__grid">
          <div class="grid__item grid__item--half about-us__content">
            <div class="section-heading no-gutter">
              ...
              <h1 class="h-1 to-left to-center font-weight-x8">shopSol quyền hạn hơn 1.000.000 doanh nghiệp trên toàn
                thế giới</h1>
        ...
        <div class="grid grid--vertical-center little-margin">
          <div class="grid__item grid__item--half section-2--content">
            <div class="section-heading section-2--content no-gutter">
              <p class="section2-heading h-5 to-left little-gutter to-center">TRUYỆN SHOPSOL</p>
              <h2 class="to-left to-center little-gutter" style="font-weight: 700">Cửa hàng shopSol đầu tiên</h2>
              <p class="text-major to-left to-center no-gutter" style="color: #6b7177">
                ...
                nay, các doanh nghiệp thuộc mọi quy mô đều sử dụng shopSol,
        ...
        <div class="grid grid--vertical-center section4-container section4-container-flipped">
          ...
          <div class="grid__item grid__item--half pull-half">
            <div class="section4-left">
              <div class="section-heading no-gutter">
                <p class="firstp h-5 little-gutter to-center to-left">ĐỘI NGŨ SHOPSOL</p>
                ...
                <p class="section-heading__subtitle text-major to-left to-center no-gutter">
                  shopSol đã phát triển từ 5 người trong một quán cà phê đến lên hơn 5.000 người trên toàn cầu. Với hơn
                  1.000.000 doanh nghiệp được cung cấp bởi shopSol, chúng
        ...
        <div class="grid grid--vertical-center section4-container">
          ...
          <div class="grid__item grid__item--half">
            <div class="section5-content">
              <div class="section-heading no-gutter">
                <p class="firstp h-5 to-left to-center little-gutter">SỰ ĐÓNG GÓP TOÀN CẦU CỦA SHOPSOL</p>
                ...
                <p class="section-heading__subtitle text-major to-left to-center">
                  Từ năm 2016 đến 2019 các doanh nghiệp shopSol đã đóng góp 319 tỷ đô la vào hoạc động kinh tế thế giới.
        ...
        <div class="grid grid--vertical-center section4-container section4-container-flipped">
          <div class="grid__item grid__item--half grid__item--push-half img-flipped about-video__container">
            <div class="avideo">
              <span class="lazyload-img" style="max-width: 1369px; max-height: 877px">
                <span class="img-placeholder" style="padding-bottom: 64.0614%">
                  <img class="section4-img" src="img/about-us-section6.jpeg" alt="section6-pict" />
                </span>
              </span>
            </div>
          </div>
          <div class="grid__item grid__item--half pull-half">
            <div class="section4-left">
              <div class="section-heading no-gutter">
                <p class="firstp h-5 to-left to-center little-gutter">SHOPSOL cam kết về sự bền vững</p>
                <h2 class="heading-h2 to-left to-center little-gutter">Chúng tôi xây dựng công ty 100 năm</h2>
                <p class="section-heading__subtitle text-major to-left to-center">
                  shopSol xây dựng dựa trên sự bền vững đồng nghĩa với việc đóng góp vào cộng đồng. Quỹ Bền vững và các
        ...
        <div class="grid">
          <div class="grid__item table-up-full mobile-up-half mobile-up-center">
            <div class="section-heading">
              <h2 class="heading-h2" style="color: #004c3f">Tìm hiểu nhiều hơn về shopSol</h2>
            </div>
          </div>
        ...
        <div class="grid">
          <div class="grid__item">
            <div class="section-heading section8-heading no-gutter">
              <h2 class="h-2 next-step">Trải nghiệm shopSol miễn phí, dịch vụ và khám phá công cụ bạn cần bắt đầu, điều
  ...
  <div id="footer">
    <div class="container-fluid my-footer" style="background-color: #002e25">
      ...
      <div class="row" style="padding-top: 40px">
        ...
        <div class="col-4 col-md-4">
          <a href="./index.php" class="my-title-col">SHOPSOL</a><br />
          <a href="./contact.php">Liên hệ </a><br />
          <a href="./examples.php">Sản phẩm mẫu </a>
        </div>
        <div class="col-4 col-md-4">
